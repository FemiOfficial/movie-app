...
import { createMovieController, createMoviesService } from './controllers/movies';
...
import { createCharacterController, createCharacterService } from "./controllers/characters";
...
const moviesService = createMoviesService(movieRepository, characterepository, commentRepository, swapClient);
...
const app = appFactory(movieController, characterController, corsMiddleware);
